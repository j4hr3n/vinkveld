<script lang="ts">
    ...
    let myRegistration = $derived(
        myPairId ? registrations[myPairId] : undefined,
    );
    let myPair = $derived(
...
<div class="space-y-6">
    ...
    {:else}
            ...
            <div class="flex items-center gap-3 animate-fade-in flex-wrap">
                ...
                >
                    ...
                    {:else}
                        ...
                        >
                            <path
                                d="M2 2l12 12M4.5 6.5C3.2 7.3 2 8 2 8s2.5 5 7 5c1 0 1.9-.3 2.7-.7M7 3.2c.3-.1.6-.2 1-.2 4.5 0 7 5 7 5s-.7 1.4-2 2.7"
        ...
        {#if !currentUser}
            <div
                class="p-5 rounded-2xl bg-wine/[0.04] border border-wine-light/25 animate-rise-in"
            >
                <div class="flex items-start gap-3 mb-3">
                    <div class="text-2xl shrink-0">🍇</div>
                    <div>
                        <h3 class="text-base font-semibold text-wine mb-1">
                            Velkommen til drueaften!
                        </h3>
                        <p
                ...
                <div
                    class="ml-9 p-3 rounded-xl bg-white/60 border border-cream-dark/40"
                >
                    <div class="flex items-center gap-2">
                        <svg
                            class="w-4 h-4 text-wine/60 shrink-0"
                            viewBox="0 0 16 16"
                            fill="none"
                            stroke="currentColor"
                            stroke-width="1.5"
                        ...
                        <span class="text-[0.82rem] text-text"
                            >Trykk på profil-knappen oppe til høyre og velg
                            navnet ditt for å komme i gang.</span
                        >
                    </div>
                </div>
            </div>
        ...
        <div class="animate-fade-in">
            ...
            >
                ...
                >
                    ...
                    <path
                        d="M6 6.5a2 2 0 1 1 2.5 1.9c-.3.1-.5.4-.5.7V10"
                        stroke-linecap="round"
            ...
            {#if showHelp}
                <div
                    class="mt-2 p-4 rounded-xl bg-wine/[0.03] border border-wine-light/20 animate-fade-in space-y-3"
                >
                    ...
                    <div class="flex items-start gap-2.5">
                        ...
                        >
                            <p class="font-medium text-text mb-0.5">
                                Trenger ikke være 100%
                            </p>
                            <p>
                                Vinen trenger ikke være laget av kun den
                                tildelte druen. Det holder at den er hoveddruen
                                i en blend.
                            </p>
                        </div>
                    </div>
        ...
        {#if myPairId && myGrapeId && !isRevealed}
            {#if myRegistration && !showRegistrationForm}
                ...
                >
                    <svg
                        class="w-4 h-4 text-wine/50 shrink-0"
                        viewBox="0 0 16 16"
                        fill="none"
                        stroke="currentColor"
                        stroke-width="1.5"
                    ...
                    <span class="text-[0.82rem] text-text-light"
                        >Endre din registrering</span
                    >
                </button>
            {:else}
                <div class="animate-rise-in">
                    {#key myRegistration?.registered}
